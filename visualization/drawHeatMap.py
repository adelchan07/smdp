...
landmark = location = {"h1": (6,2), "h2": (10,6), "h3": (3,6), "h4": (7,9)}
...
def drawHeatMap(width, height, V, goalState, policy, fig, ax, primitiveText, landmarkText, landmarkLocation, landmarkPolicies):
...
def drawFinalMap(V, width, height, goalState, policy, primitiveText, landmarkText, landmarkLocation, landmarkPolicies):
    ...
    drawHeatMap(width, height, V, goalState, policy, fig, ax, primitiveText, landmarkText, landmarkLocation, landmarkPolicies)
